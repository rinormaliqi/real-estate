        ...
        <div className="col-xl-7 col-lg-6">
          <div className="pe-xl-5 me-xxl-3 wow fadeInLeft">
            <div className="title-one pe-xl-5">
              <h2 className="font-garamond">Eksploroni & Gjeni Shtëpinë tuaj të <em>Ëndrrave</em> <span className="star-shape"><Image src={featureimg_1} alt="" className="lazy-img" /></span></h2>
            </div>
        ...
        <div className="col-xl-5 col-lg-6">
          <div className="block-two ps-xxl-5 md-mt-100">
            <div className="bg-wrapper wow fadeInRight">
              <p className="fs-24 fst-italic pe-xl-5">“Partneri juaj kryesor në pasuri të paluajtshme. Shndërrojmë pronat në ëndrra. Le të ju udhëzojmë në shtëpi me ekspertizë.”</p>
              <div className="counter-wrapper pb-40 mt-45 lg-mt-20 mb-60 lg-mb-20">
                <div className="row">
                  <div className="col-6">
                    <div className="counter-block-one mt-20">
                      <div className="main-count fw-500 color-dark">$<span className="counter"><Count number={7} /></span>mil+</div>
                      <span>Projekte të Dorëzuara</span>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="counter-block-one mt-20">
              ...
              <ul className="list-style-one fs-22 color-dark style-none">
                <li>Mundësi kredie me interes të ulët</li>
                <li>Mbi 100k lista pasurish të shtuara & përditësuara</li>
                <li>Konsultim me agjentë ekspertë</li>
              </ul>
              <div className="mt-70 lg-mt-50">
                <Link href="/about_us_02" className="btn-five md"><span>Mësoni Më Shumë</span> <i className="bi bi-arrow-up-right"></i></Link>
              </div>
            </div>
          </div>
        </div>
